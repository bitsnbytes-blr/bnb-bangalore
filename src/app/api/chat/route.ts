...
Core Leadership:
- Sparsh Sharma: Lead of Bits & Bytes Bangalore, and the developer who built this website. 17-year-old self-taught full-stack developer from Bangalore (hometown Dhampur). Built OrbitVoyage, Manshverse, Lexivoid, and Conduit. Known for "Manshverse" and "Sparnity". He is the Founder/CEO.
- Rohan: Co-Lead of Bits & Bytes Bangalore. He works closely with Sparsh to run the Bangalore Fork.
- Manyatha Raj MK: 17-year-old content writer, poet (@manyathaa.writes), and storyteller blending digital strategy with creative expression. Role: Design and Writing. (She is the "one more whatever she was").
- Narthan Shetty: 16-year-old editor, developer & IT lead from Bangalore. Role: Design and Editing.
- Shyam Awasthi: Class 12 PCM student, technical and outreach lead (CTO/Outreach).
- Akshat Kushwaha: Built HybridMind and Luna.
